...
{
    /// <summary>
    /// The Editor for a RuleTileWithOther.
    /// </summary>
    [CustomEditor(typeof(RuleTileWithOther), true)]
    [CanEditMultipleObjects]
    public class RuleTileWithOtherEditor : UnityEditor.Editor
    {
        ...
        private static readonly string k_UndoName = L10n.Tr("Change RuleTileWithOther");
        ...
        private static class Styles
        {
            ...
            public static readonly GUIContent emptyRuleTileWithOtherInfo =
        ...
        /// <summary>
        /// The RuleTileWithOther being edited
        /// </summary>
        public RuleTileWithOther tile => target as RuleTileWithOther;
        ...
        /// <summary>
        /// Whether the RuleTileWithOther can extend its neighbors beyond directly adjacent ones
        /// </summary>
        ...
        /// <summary>
        /// OnEnable for the RuleTileWithOtherEditor
        /// </summary>
        public virtual void OnEnable()
        {
            m_ReorderableList = new ReorderableList(tile != null ? tile.m_TilingRules : null, typeof(RuleTileWithOther.TilingRule), true, true, true, true);
        ...
        /// <summary>
        /// OnDisable for the RuleTileWithOtherEditor
        /// </summary>
        ...
        public virtual BoundsInt GetRuleGUIBounds(BoundsInt bounds, RuleTileWithOther.TilingRule rule)
        {
            if (extendNeighbor)
            {
                bounds.xMin--;
        ...
        {
            RuleTileWithOther.TilingRule rule = tile.m_TilingRules[index];
        ...
        public float GetElementHeight(RuleTileWithOther.TilingRule rule)
        {
            BoundsInt bounds = GetRuleGUIBounds(rule.GetBounds(), rule);

            float inspectorHeight = GetElementHeight(rule as RuleTileWithOther.TilingRuleOutput);
        ...
        public float GetElementHeight(RuleTileWithOther.TilingRuleOutput rule)
        {
            float inspectorHeight = k_DefaultElementHeight + k_PaddingBetweenRules;

            switch (rule.m_Output)
            {
                case RuleTileWithOther.TilingRuleOutput.OutputSprite.Random:
                case RuleTileWithOther.TilingRuleOutput.OutputSprite.Animation:
        ...
        /// <summary>
        /// Gets the GUI matrix size for a Rule of a RuleTileWithOther
        /// </summary>
        /// <param name="bounds">Cell bounds of the Rule.</param>
        /// <returns>Returns the GUI matrix size for a Rule of a RuleTileWithOther.</returns>
        ...
        private void OnAddElement(object obj)
        {
            ...
            RuleTileWithOther.TilingRule rule = new RuleTileWithOther.TilingRule();
            rule.m_Output = RuleTileWithOther.TilingRuleOutput.OutputSprite.Single;
            ...
            ResizeRuleTileWithOtherList(count + 1);
        ...
        /// <summary>
        /// Saves any changes to the RuleTileWithOther
        /// </summary>
        ...
        /// <summary>
        /// Updates all RuleOverrideTileWithOthers which override the given RUleTile
        /// </summary>
        /// <param name="target">RuleTileWithOther which has been updated</param>
        public static void UpdateAffectedOverrideTiles(RuleTileWithOther target)
        {
            List<RuleOverrideTileWithOther> overrideTiles = FindAffectedOverrideTiles(target);
        ...
        /// <summary>
        /// Gets all RuleOverrideTileWithOthers which override the given RuleTileWithOther
        /// </summary>
        /// <param name="target">RuleTileWithOther which has been updated</param>
        /// <returns>A list of RuleOverrideTileWithOthers which override the given RuleTileWithOther</returns>
        public static List<RuleOverrideTileWithOther> FindAffectedOverrideTiles(RuleTileWithOther target)
        {
            List<RuleOverrideTileWithOther> overrideTiles = new List<RuleOverrideTileWithOther>();

            string[] overrideTileGuids = AssetDatabase.FindAssets("t:" + typeof(RuleOverrideTileWithOther).Name);
            foreach (string overrideTileGuid in overrideTileGuids)
            {
                ...
                RuleOverrideTileWithOther overrideTile = AssetDatabase.LoadAssetAtPath<RuleOverrideTileWithOther>(overrideTilePath);
        ...
        /// <summary>
        /// Draws the Inspector GUI for the RuleTileWithOtherEditor
        /// </summary>
        public override void OnInspectorGUI()
        {
            ...
            if (count < 0)
                count = 0;
            if (EditorGUI.EndChangeCheck())
                ResizeRuleTileWithOtherList(count);
            ...
            if (count == 0)
            {
                ...
                DisplayClipboardText(Styles.emptyRuleTileWithOtherInfo, rect);
        ...
        private void ResizeRuleTileWithOtherList(int count)
        {
            ...
            if (isEmpty)
            {
                for (int i = 0; i < count; ++i)
                    tile.m_TilingRules[i] = new RuleTileWithOther.TilingRule();
            }
            UpdateTilingRuleIds();
        }

        /// <summary>
        /// Draw editor fields for custom properties for the RuleTileWithOther
        /// </summary>
        ...
        /// <summary>
        /// Gets the index for a Rule with the RuleTileWithOther to display an arrow.
        /// </summary>
        /// <param name="position">The relative position of the arrow from the center.</param>
        /// <returns>Returns the index for a Rule with the RuleTileWithOther to display an arrow.</returns>
        ...
        public virtual void RuleOnGUI(Rect rect, Vector3Int position, int neighbor)
        {
            switch (neighbor)
            {
                case RuleTileWithOther.TilingRuleOutput.Neighbor.This:
                    GUI.DrawTexture(rect, arrows[GetArrowIndex(position)]);
                    break;
                case RuleTileWithOther.TilingRuleOutput.Neighbor.NotThis:
        ...
        public virtual void RuleTransformOnGUI(Rect rect, RuleTileWithOther.TilingRuleOutput.Transform ruleTransform)
        {
            switch (ruleTransform)
            {
                case RuleTileWithOther.TilingRuleOutput.Transform.Rotated:
                    GUI.DrawTexture(rect, autoTransforms[0]);
                    break;
                case RuleTileWithOther.TilingRuleOutput.Transform.MirrorX:
                    GUI.DrawTexture(rect, autoTransforms[1]);
                    break;
                case RuleTileWithOther.TilingRuleOutput.Transform.MirrorY:
                    GUI.DrawTexture(rect, autoTransforms[2]);
                    break;
                case RuleTileWithOther.TilingRuleOutput.Transform.Fixed:
                    GUI.DrawTexture(rect, autoTransforms[3]);
                    break;
                case RuleTileWithOther.TilingRuleOutput.Transform.MirrorXY:
        ...
        public void RuleNeighborUpdate(Rect rect, RuleTileWithOther.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors, Vector3Int position)
        {
        ...
        public void RuleTransformUpdate(Rect rect, RuleTileWithOther.TilingRule tilingRule)
        {
            if (Event.current.type == EventType.MouseDown && ContainsMousePosition(rect))
            {
                tilingRule.m_RuleTransform = (RuleTileWithOther.TilingRuleOutput.Transform)(int)Mathf.Repeat((int)tilingRule.m_RuleTransform + GetMouseChange(), Enum.GetValues(typeof(RuleTileWithOther.TilingRule.Transform)).Length);
                GUI.changed = true;
                Event.current.Use();
            }
        }
        ...
        /// <summary>
        /// Draws a Rule Matrix for the given Rule for a RuleTileWithOther.
        /// </summary>
        ...
        public virtual void RuleMatrixOnGUI(RuleTileWithOther tile, Rect rect, BoundsInt bounds, RuleTileWithOther.TilingRule tilingRule)
        {
        ...
        /// <summary>
        /// Draws a Rule Matrix Icon for the given matching Rule for a RuleTileWithOther with the given position
        /// </summary>
        /// <param name="tilingRule">Tile to draw rule for.</param>
        /// <param name="neighbors">A dictionary of neighbors</param>
        /// <param name="position">The relative position of the neighbor matching Rule</param>
        /// <param name="rect">GUI Rect to draw icon at</param>
        public void RuleMatrixIconOnGUI(RuleTileWithOther.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors, Vector3Int position, Rect rect)
        {
        ...
        public virtual void SpriteOnGUI(Rect rect, RuleTileWithOther.TilingRuleOutput tilingRule)
        {
        ...
        public void RuleInspectorOnGUI(Rect rect, RuleTileWithOther.TilingRuleOutput tilingRule)
        {
            float y = rect.yMin;
            ...
            tilingRule.m_Output = (RuleTileWithOther.TilingRuleOutput.OutputSprite)EditorGUI.EnumPopup(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), tilingRule.m_Output);
            y += k_SingleLineHeight;

            if (tilingRule.m_Output == RuleTileWithOther.TilingRuleOutput.OutputSprite.Animation)
            {
            ...
            if (tilingRule.m_Output == RuleTileWithOther.TilingRuleOutput.OutputSprite.Random)
            {
                ...
                tilingRule.m_RandomTransform = (RuleTileWithOther.TilingRuleOutput.Transform)EditorGUI.EnumPopup(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), tilingRule.m_RandomTransform);
                y += k_SingleLineHeight;
            }

            if (tilingRule.m_Output != RuleTileWithOther.TilingRuleOutput.OutputSprite.Single)
            {
                GUI.Label(new Rect(rect.xMin, y, k_LabelWidth, k_SingleLineHeight)
                    , tilingRule.m_Output == RuleTileWithOther.TilingRuleOutput.OutputSprite.Animation ? Styles.tilingRulesAnimationSize : Styles.tilingRulesRandomSize);
                EditorGUI.BeginChangeCheck();
        ...
        private void HandleDragAndDrop(Rect guiRect)
        {
            ...
            switch (Event.current.type)
            {
                ...
                case EventType.DragPerform:
                {
                    ...
                    ResizeRuleTileWithOtherList(dragAndDropSprites.Count);
        ...
        /// <summary>
        /// Whether the RuleTileWithOther has a preview GUI
        /// </summary>
        ...
        /// <summary>
        /// Draws the preview GUI for the RuleTileWithOther
        /// </summary>
        ...
        /// <summary>
        /// Creates a Preview for the RuleTileWithOther.
        /// </summary>
        ...
        /// <summary>
        /// Renders a static preview Texture2D for a RuleTileWithOther asset
        /// </summary>
        /// <param name="assetPath">Asset path of the RuleTileWithOther</param>
        ...
        /// <returns>Texture2D containing static preview for the RuleTileWithOther asset</returns>
        ...
        /// </summary>
        [Serializable]
        class RuleTileWithOtherRuleWrapper
        {
            /// <summary>
            /// List of Rules to serialize
            /// </summary>
            [SerializeField]
            public List<RuleTileWithOther.TilingRule> rules = new List<RuleTileWithOther.TilingRule>();
        }

        /// <summary>
        /// Copies all Rules from a RuleTileWithOther to the clipboard
        /// </summary>
        /// <param name="item">MenuCommand storing the RuleTileWithOther to copy from</param>
        [MenuItem("CONTEXT/RuleTileWithOther/Copy All Rules")]
        public static void CopyAllRules(MenuCommand item)
        {
            RuleTileWithOther tile = item.context as RuleTileWithOther;
            if (tile == null)
                return;

            RuleTileWithOtherRuleWrapper rulesWrapper = new RuleTileWithOtherRuleWrapper();
        ...
        /// <summary>
        /// Pastes all Rules from the clipboard to a RuleTileWithOther
        /// </summary>
        /// <param name="item">MenuCommand storing the RuleTileWithOther to paste to</param>
        [MenuItem("CONTEXT/RuleTileWithOther/Paste Rules")]

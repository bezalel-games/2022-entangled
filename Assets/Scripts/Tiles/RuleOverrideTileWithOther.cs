...
namespace Tiles
{
    ...
    [Serializable]
    public class RuleOverrideTileWithOther : TileBase
    {
        ...
        /// </summary>
        public RuleTileWithOther m_Tile;
        /// <summary>
        ...
        /// </summary>
        [HideInInspector] public RuleTileWithOther m_InstanceTile;

        private void CreateInstanceTile()
        {
            var t = m_Tile.GetType();
            RuleTileWithOther instanceTile = CreateInstance(t) as RuleTileWithOther;
        ...
        public void GetOverrides(List<KeyValuePair<Sprite, Sprite>> overrides, ref int validCount)
        {
            ...
            if (m_Tile)
            {
                ...
                foreach (RuleTileWithOther.TilingRule rule in m_Tile.m_TilingRules)
